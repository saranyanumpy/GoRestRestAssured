...
public class PatchInvalidEmail extends BaseTest {
	private static final Logger logger = LoggerFactory.getLogger(PatchInvalidEmail.class);
    ...
    public void testCreateUser(String userId,String name, String email, String gender, String status) {
    			logger.info("Starts Patching Invalid Email...");
    	     ...
    	     //   int invalidId = TestDataManager.getUserId() + 9999;
    	        ...
    	        logger.info("Finished Patching Invalid Email handled correctly.");
    	    }
    	}
