...
public class UpdateByInvalidEmail extends BaseTest {

	private static final Logger logger = LoggerFactory.getLogger(UpdateByInvalidEmail.class);
    ...
    public void testCreateUser(String userId,String name, String email, String gender, String status) {
    			logger.info("Starting Invalid Email...");
